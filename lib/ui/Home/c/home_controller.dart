    ...
    _ListenerProjectDetailsList().then((value){
      ...
      list.forEach((element) {
        if(element.shotcrete_application_package.toString()=="1"&&element.details!=null){
          ...
          short.volume=0;
          short.dump_volume=0;
          short.euipment_performance_date="";
          Map<String,dynamic>map=Map();
          map['details']=jsonEncode(element.details!.toMap());
          map['file_type']="2";
          map['project_id']=projectResponse!.id;
          _ListenerUpdateTask(map,element.id).then((value){
